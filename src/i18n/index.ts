...
export const strings = {
  'pt-br': {
    ...
    profile: 'Perfil',
    arsenal: 'Arsenal',
    stackLabels: { focus: 'Foco', languages: 'Linguagens', tools: 'Ferramentas' },
    contact: 'Contato',
  ...
  en: {
    ...
    profile: 'Profile',
    arsenal: 'Arsenal',
    stackLabels: { focus: 'Focus', languages: 'Languages', tools: 'Tools' },
    contact: 'Contact',
    navWriteups: 'Writeups',
    navAbout: 'About',
